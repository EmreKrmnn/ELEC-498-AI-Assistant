...
2) Retrieve the top-k most similar dataset rows from Postgres (pgvector)
3) Ask an LLM to answer using the retrieved rows as context
"""
...
# Your embedder (already truncates and calls OpenAI embeddings)
